...
import { fetchPublicImages, fetchImages, fetchVotes, fetchFaves, upvoteImage, downvoteImage, favImage, unfavImage } from '../services/DogsApi'
import { useSnackbar } from 'notistack'

export function MyImagesPage(props: RouteComponentProps) {
